...
7010kHz送信出力は，5V(Ardiuno nanoからの電源供給)で約0.2W， 電源12Vで約2Wでした．  
...
結合トランスにFCZコイル（9MHz用,サトー電気）+共振コンデンサー(62pF)を用い，CRK-10Aの10MHzモデルのLPFの回路で実験したところ，10110kHzでの送信出力は，5V(Ardiuno nanoからの電源供給)で約0.2W， 電源12Vで約1Wでした．  
