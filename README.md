...
## QP-7Cミニ送信機の改造（その4）の追加 その5 （WSJT-X ver2.5.4のCAT対応）
	
スケッチ"QP-7C_TRX-PCB.ino"をアップデートしました．  
もともと，Kenwood TS-2000をエミュレートしていましたが，対応コマンドが少なくWSJT-X ver2.5.4のCATでは使用できませんでした．  
対応コマンドを2個増やして，WSJT-X ver2.5.4のCATに対応しました．  
...
一旦，7.074MHzに設定すると，FSKモードに移行するようです．  
...
## QP-7Cミニ送信機の改造（その5）の追加 （WSJT-X ver2.5.4のCAT対応）
