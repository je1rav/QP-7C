...
元はドイツ語なのでGoogle翻訳やDeepL翻訳を使って読みました．  
基本原理は，以下の通りです．  
...
（これでは，ダイナミックイヤフォンを接続しても音量が小さいので，追加アンプを付けるかセラミックイヤフォンを使用する必要があります．）  　　
（CA3028 Rxキットを使えばオーディオアンプが付いているので，PCでもダイナミックイヤフォンでもスピーカーでも大丈夫)  
...
Arduino Nano用スケッチ例(QP-7C_FT8_tranceiver.ico)は以下の通り．  
